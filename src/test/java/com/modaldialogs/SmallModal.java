...
public class SmallModal {
	...
	try {
        ...
        String smallModal = p.getProperty("smallModal");	
        String closeSmallModel = p.getProperty("closeSmallModel");	
		...
		d.findElement(By.xpath(smallModal)).click();
		Thread.sleep(3000);


		d.findElement(By.xpath(closeSmallModel)).click();
		Thread.sleep(3000);
