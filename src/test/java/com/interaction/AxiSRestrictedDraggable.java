...
public class AxiSRestrictedDraggable {
	...
	public void axisRestrictedDraggable() {
	...
	try {
        ...
        String xAxis = p.getProperty("xAxis");	
        String yAxis = p.getProperty("yAxis");	
        String axisRestricted = p.getProperty("axisRestricted");	
		...
		d.findElement(By.xpath(axisRestricted)).click();
		Thread.sleep(3000);

		
		 WebElement element1 = d.findElement(By.xpath(xAxis));
		
		WebElement element2 = d.findElement(By.xpath(yAxis));
