...
public class SimpleDroppable {
	...
	try {
        ...
        String drag = p.getProperty("drag");	
        String drop = p.getProperty("drop");	
		...
		Thread.sleep(3000);
		 ...
		 WebElement element1 = d.findElement(By.xpath(drag));
		
		WebElement element2 = d.findElement(By.xpath(drop));
