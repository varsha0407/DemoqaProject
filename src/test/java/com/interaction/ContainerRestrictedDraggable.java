...
public class ContainerRestrictedDraggable {
	...
	public void containerRestrictedDraggable() {
	...
	try {
        ...
        String containedBox = p.getProperty("containedBox");	
        String containedParent = p.getProperty("containedParent");	
        String containerRestricted = p.getProperty("containerRestricted");	
		...
		d.findElement(By.xpath(containerRestricted)).click();
		Thread.sleep(3000);

		
		 WebElement element1 = d.findElement(By.xpath(containedBox));
		
		WebElement element2 = d.findElement(By.xpath(containedParent));
