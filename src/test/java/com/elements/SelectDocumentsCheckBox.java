...
public class SelectDocumentsCheckBox {
	...
	public void selectDocumentsCheckBox() {
	...
	try {
		...
		String documentsCheckBox = p.getProperty("documentsCheckBox");	
		...
		d.findElement(By.xpath(documentsCheckBox)).click();
		Thread.sleep(2000);
