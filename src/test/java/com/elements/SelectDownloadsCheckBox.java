...
public class SelectDownloadsCheckBox {
	...
	try {
		...
		String downloadCheckBox = p.getProperty("downloadCheckBox");	
		...
		//click on download CheckBox
		
		d.findElement(By.xpath(downloadCheckBox)).click();
		Thread.sleep(2000);
