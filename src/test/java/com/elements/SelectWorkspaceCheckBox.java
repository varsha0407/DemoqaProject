...
public class SelectWorkspaceCheckBox {
	...
	public void selectWorkspaceCheckBox() {
	...
	try {
		...
		String workspaceCheckBox = p.getProperty("workspaceCheckBox");	
		...
		//click on workspace CheckBox
		
		d.findElement(By.xpath(workspaceCheckBox)).click();
		Thread.sleep(2000);
